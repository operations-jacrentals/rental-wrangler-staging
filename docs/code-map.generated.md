...
## app.js — 23513 lines, 38 chapters
...
| APP-30 | 15056–15323 | §14 | §14 RENDER PIPELINE + toast | renderCount, scrollMemo, render, renderResults, _titlesRaf, applyTitles, HOVER_CAPABLE, initTooltip, hideTip, swInit, PERF, perfInit, …(+2) |
...
| APP-37 | 20419–22962 | §18b | §18b BACKEND SYNC — Google Sheets via the Apps Script web app | BACKEND_URL, PERSIST_KEYS, backendPassword, booting, saveTimer, driveViewUrl, backendCall, gpsToken, gpsBase, gpsConfigured, gpsFetch, gpsLogin, …(+159) |
| APP-38 | 22963–23513 | — | D8/D9 THE COMMS RAIL (spec comms-notifications D8 + D9, Jac | COMMS_CAT_META, commsOnline, commsSess, commsCatOfChannel, commsThreads, commsThreadsAt, refreshCommsThreads, commsThreadChannel, commsThreadsFor, commsConvStatus, COMMS_ST_RANK, commsCatWorst, …(+33) |
